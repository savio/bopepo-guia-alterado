...
package br.com.jrimum.bopepo.view.guia;
...
import br.com.jrimum.utilix.FileUtil;
import br.com.jrimum.utilix.MonetaryUtil;
import br.com.jrimum.utilix.PDFUtil;
import br.com.jrimum.utilix.RectanglePDF;
...
class ViewerPDF {
	...
	private void setValorCobrado() throws IOException, DocumentException {
		...
		if(isNotNull(guia.getArrecadacao().getValorDocumento())){
			valorStr = MonetaryUtil.FORMAT_REAL.format(guia.getArrecadacao().getValorDocumento());
			form.setField("txtRsValorCobrado", valorStr);
			form.setField("txtFcValorCobrado", valorStr);
		}
	}
	 ...
	 * 
	 */
	private void setDescontos() throws IOException, DocumentException {
		String valorStr = null;
		
		if(isNotNull(guia.getArrecadacao().getValorDesconto())){
			valorStr = MonetaryUtil.FORMAT_REAL.format(guia.getArrecadacao().getValorDesconto());
			form.setField("txtRsDescontoAbatimento", valorStr);
			form.setField("txtFcDescontoAbatimento", valorStr);
		}
	}
	...
	private void setInstrucaoAoCaixa() throws IOException, DocumentException {
		form.setField("txtFcInstrucaoAoCaixa1", guia.getInstrucaoAoCaixa1());
		form.setField("txtFcInstrucaoAoCaixa2", guia.getInstrucaoAoCaixa2());
		form.setField("txtFcInstrucaoAoCaixa3", guia.getInstrucaoAoCaixa3());
		form.setField("txtFcInstrucaoAoCaixa4", guia.getInstrucaoAoCaixa4());
	}
	...
	private void setValorDocumento() throws IOException, DocumentException {
		...
		form.setField("txtRsValorDocumento", valorStr);
		form.setField("txtFcValorDocumento",valorStr);
	}
	...
	private void setNossoNumero() throws IOException, DocumentException {
		form.setField("txtRsNossoNumero", guia.getArrecadacao().getNossoNumero());
		form.setField("txtFcNossoNumero", guia.getArrecadacao().getNossoNumero());
	}

	/**
	 * Exibe os valores de instância.
	 * 
	 * @see br.com.jrimum.utilix.ObjectUtil#toString()
	 */
	@Override
