...
package br.com.jrimum.domkee.financeiro.banco;
...
import br.com.jrimum.domkee.comum.pessoa.id.RG;
 ...
 * 
 * @see Pessoa
 * @see br.com.jrimum.domkee.comum.pessoa.id.cprf.AbstractCPRF
 * @see br.com.jrimum.domkee.comum.pessoa.id.cprf.CPF
 * 
...
public class PessoaFisica extends Pessoa implements
		br.com.jrimum.domkee.comum.pessoa.PessoaFisica {
	...
	private br.com.jrimum.domkee.comum.pessoa.PessoaFisica conjuge;
	...
	public br.com.jrimum.domkee.comum.pessoa.PessoaFisica getConjuge() {
	...
	public void setConjuge(
			br.com.jrimum.domkee.comum.pessoa.PessoaFisica conjuge) {
